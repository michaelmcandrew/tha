...
Drupal.behaviors.helplines3Equalheights = function (context) {
...
Drupal.behaviors.helplines3IE6fixes = function (context) {
...
Drupal.behaviors.helplines3Overlabel = function (context) {
  if (jQuery().overlabel) {
    $("div.helplines3-horiz-login label").overlabel();
  }
};

Drupal.behaviors.helplines3GridMask = function (context) {
...
Drupal.behaviors.helplines3GridMaskToggle = function (context) {
  if ($('body.grid-mask-enabled').size() > 0) {
...
Drupal.behaviors.helplines3PanelsShowEdit = function (context) {
...
Drupal.behaviors.helplines3Screenshotpreview = function (context) {
