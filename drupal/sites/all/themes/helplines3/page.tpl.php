...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
	  ...
	  <div id="account-menu" class="<?php print $grid_width; ?>">
	  <div id="account-menu-inner" class="clearfix">
		<?php print $accountmenu; ?>	
	  </div>
	  </div>
	  ...
	  <div id="header-group" class="header-group row <?php print $grid_width; ?>">
		...
		<div id="sitemenutop"><?php print theme('grid_block', theme('links', $primary_links), 'primary-menu'); ?></div>
		<div id="sitemenubottom"><?php print theme('grid_block', theme('links', $secondary_links), 'secondary-menu'); ?></div>
		</div>
