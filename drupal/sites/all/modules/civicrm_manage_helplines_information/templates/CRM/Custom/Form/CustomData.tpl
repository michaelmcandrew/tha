...
<!-- Added by rajesh@millertech.co.uk -->
{assign var=custom_row_id value="_"|explode:$cd_edit.fields.312.element_name}

<input type='hidden' name='custom_row_id' value={$customRowId}>

{* if $customRowId eq $custom_row_id.2 *}
 
 <tr>
    <td>
    <b>{$cd_edit.fields.312.element_value}</b>
    </td>
  </tr>
