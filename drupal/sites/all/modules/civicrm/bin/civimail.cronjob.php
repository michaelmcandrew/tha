...
//$query = "INSERT INTO civicrm_mtl_mailingcron_log SET date = '$today'";
//$dao = CRM_Core_DAO::executeQuery( $query );

$myFile = '/var/www/vhosts/helplines.millertech-civicrm.co.uk/httpdocs/sites/default/files/CiviMail.txt';
